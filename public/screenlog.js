(function() {
  ...
  function createPanel() {
    var div = createElement(
      "div",
      "box-sizing:border-box;z-index:2147483647;font-family:Helvetica,Arial,sans-serif;font-size:" +
        _options.fontSize +
        ";padding:20px;text-align:left;opacity:0.8;position:fixed;left:10px;top:10px;min-width:200px;height:calc(100vh - 20px);overflow:auto;background:" +
        _options.bgColor +
        ";" +
        _options.css
    );
